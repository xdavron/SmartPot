...
class PublishData(object):
    ...
    def load_topics(self):
        ...
        try:
            ...
            self.WaterLevel_Topic = json_format[self.plantId]["topic"]["waterTopic"]
    ...
    def publish_sensor_data(self):
        ...
        try:
            ...
            new_json_format=json.dumps({"subject":"water_level_data","plantId":self.plantId,"value": water,"time":time})
            msg_info = client.publish(self.WaterLevel_Topic, str(new_json_format), qos=1)
