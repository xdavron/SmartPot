from SoilMoisture import SoilMoisture_Reader
...
class PublishData(object):
    ...
    def load_topics(self):
        ...
        try:
            ...
            self.SoilMoisture_Topic = json_format[self.plantId]["topic"]["soilTopic"]
    ...
    def publish_sensor_data(self):
        ...
        try:
            ...
            new_json_format=json.dumps({"subject":"soil_moisture_data","plantId":self.plantId,"value": 1023-soil,"time":time})
            msg_info = client.publish(self.SoilMoisture_Topic, str(new_json_format), qos=1)
